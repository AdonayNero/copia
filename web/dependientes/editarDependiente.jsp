    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper" style=" margin: 0 50px;">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Editar Dependiente</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                Ingrese los datos a editar del dependiente
                            </div>
                                                ...
                                                <form role="form" action="${pageContext.request.contextPath}/dependientes.do" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="codigo" id="codigo" value="${dependiente.idDependiente}" readonly="true" placeholder="Ingresa el codigo del dependiente" >
                                                    ...
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="password" class="form-control" name="clave" id="clave" value="${dependiente.clave}" readonly="true"  placeholder="Ingresa el password del dependiente" >
                                                            <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                                                        </div>
                                                     </div>
                                                       <div>
