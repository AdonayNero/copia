    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Lista de promociones <span class="label label-danger">Rechazadas</span></h1>
                    </div>
                </div>
               <div class="row">
                    <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="TablaCuponera">
                                    ...
                                    <tbody>   
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="label label-danger">${espera.estado.estado}</span></td>
